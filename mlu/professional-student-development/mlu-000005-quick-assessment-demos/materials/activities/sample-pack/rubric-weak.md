...
>
> This is the **"original" rubric** for the Stress Test and the hook: the kind of rubric many
> assignments actually ship with. It is weak on purpose. Don't fix it — its weaknesses are what the
> demo shows.
...
| **Length & Formatting** | 10 | **9–10** — Meets the length requirement; formatted correctly. | **7–8** — Slightly off length or format. | **5–6** — Noticeably off. | **0–4** — Far off. |

**Total: 100 points** · A 90–100 · B 80–89 · C 70–79 · D 60–69 · F below 60

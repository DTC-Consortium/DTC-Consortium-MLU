...
| [`materials/agenda/SEMINAR_PLAN.md`](materials/agenda/SEMINAR_PLAN.md) | Agenda and design decisions for the seminar this lab anchors |
...
3. **Facilitators: work `materials/facilitator-guide/PREFLIGHT_CHECKLIST.md` before delivery.**
   The Hugging Face free tier occasionally rate-limits; the checklist covers what to do about it.
